...
//   LoadGrid() {
//     this.loaderService.showLoader();
//     this.formattedFromDate = DateUtils.formatDateToMMDDYYYY(this.fromDate);
//     this.formattedToDate = DateUtils.formatDateToMMDDYYYY(this.toDate);
...
//     this.fromDate = DateUtils.convertDDMMYYYYToDate(date); // this.datepipe.transform(data.value, 'MM-dd-yyyy');
//     console.log("fromDate : ", this.fromDate);
//     this.formattedFromDate = DateUtils.formatDateToMMDDYYYY(this.fromDate);
//     this.LoadGrid();
//   }
...
//     this.toDate = DateUtils.convertDDMMYYYYToDate(date); // this.datepipe.transform(data.value, 'MM-dd-yyyy');
//     this.formattedToDate = DateUtils.formatDateToMMDDYYYY(this.toDate);
//     this.LoadGrid();
//   }
